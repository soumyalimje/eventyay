...
<https://github.com/fossasia/eventyay-vimeo>`_ (manual embedding) or our `plugin
for media.ccc.de <https://github.com/fossasia/eventyay-media-ccc-de>`_ (using an
API).
...
subclass of ``eventyay.agenda.recording.BaseRecordingProvider``::
...
.. class:: eventyay.agenda.recording.BaseRecordingProvider
