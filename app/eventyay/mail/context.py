    ...
    placeholders = [
        *placeholder_aliases(
        ...
        SimpleFunctionalMailTextPlaceholder(
            ...
            lambda event: f'https://eventyay.com/{event.slug}/',
        ...
        SimpleFunctionalMailTextPlaceholder(
            ...
            lambda event: f'https://eventyay.com/{event.slug}/schedule/',
        ...
        *placeholder_aliases(
        ...
        SimpleFunctionalMailTextPlaceholder(
            ...
            'https://eventyay.example.com/democon/schedule/F8VVL/',
        ...
        *placeholder_aliases(
            ...
            'https://eventyay.example.com/democon/me/submissions/F8VVL/',
        ...
        SimpleFunctionalMailTextPlaceholder(
            ...
            'https://eventyay.example.com/democon/me/submissions/F8VVL/confirm',
        ...
        *placeholder_aliases(
            ...
            _('A list of all changes to the user’s schedule in the current schedule version.'),
        ),
        SimpleFunctionalMailTextPlaceholder(
